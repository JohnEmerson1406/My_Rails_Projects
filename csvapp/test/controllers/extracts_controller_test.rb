...
class ExtractsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create extract" do
    assert_difference('Extract.count') do
      post extracts_url, params: { extract: { kind: @extract.kind, movement: @extract.movement, value: @extract.value } }
    end
  ...
  test "should update extract" do
    patch extract_url(@extract), params: { extract: { kind: @extract.kind, movement: @extract.movement, value: @extract.value } }
